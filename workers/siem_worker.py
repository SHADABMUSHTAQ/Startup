            ...
            for stream_name, msg_list in messages:
                for msg_id, msg_data in msg_list:
                    try:
                        ...
                        # Insert the enriched log with explicit _id for idempotency
                        ...
                        try:
                            ...
                            # Safe to acknowledge and drop from queue
                        ...
                        # Outer catch for unexpected errors during validation (not database)
