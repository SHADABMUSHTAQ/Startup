...
function Features() {
  ...
  const features = [
    // --- TOP ROW: CORE SIEM CAPABILITIES ---
    {
      ...
      description:
        "Monitor network and endpoint logs 24/7. Identify anomalies instantly via strict correlation rules.",
    ...
    },
    {
      ...
      description:
        "Centralize telemetry. Collect data seamlessly via automated Windows Agents or secure manual uploads.",
    ...
    },
    {
      ...
      description:
        "Receive immediate alerts for critical events. Isolate threats and mitigate risks before impact.",
    ...
    // --- BOTTOM ROW: COMPLIANCE & AUDIT ---
    {
      ...
      description:
        "Secure logs using WORM technology. Maintain a cryptographic chain of custody for legal admissibility.",
      icon: <Lock size={32} />,
    },
    {
      id: 5,
      ...
      description:
        "Fulfill strict regulatory policies. Scale seamlessly from instant hot storage to multi-year cold archives.",
    ...
    },
    {
      ...
      description:
        "Generate compliance-ready reports for FBR and PECA effortlessly with a single click.",
    ...
    <section className="features-section" id="features" ref={sectionRef}>
      ...
      <div className="features-container">
        ...
        <div className="section-header reveal-on-scroll">
          ...
          <p>
            Built for modern security teams who demand speed, scale, and
            accuracy.
          </p>
        </div>
              ...
              >
                <div className="feature-center-meta">
                  ...
                  <span className="feature-index">
                    Feature 0{activeFeature.id}
                  </span>
                </div>
                <div className="feature-center-heading">
                  <span className="feature-center-icon">
                    {activeFeature.icon}
                  </span>
