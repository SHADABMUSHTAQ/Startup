        ...
        groups: [
          {
            ...
            items: [
              "Hot Storage (30 days): Pakistan-based servers (Production) / Azure Singapore (Pilot Phase) for real-time dashboards.",
              "Warm Storage (90 days): Pakistan-based servers / Azure Singapore (Pilot Phase) for investigation.",
              "Cold Archive (Up to 6 years): Pakistan-based archive + Azure Encrypted Archive (Pilot Phase) for long-term compliance retention.",
            ],
          },
          {
            title: "4.2 Mandatory Retention Periods",
            items: [
              "Network Traffic Metadata (PECA Section 32): Minimum 1 year",
              "FBR POS Integrity Logs: Mandatory 6 years",
              "Financial, Tax, and Billing Records: 6 years from creation date",
            ],
          },
          {
            title: "4.3 Data Sovereignty (Pilot Phase Disclosure)",
            intro:
              "During WarSOC's pilot phase, anonymized and tokenized log data may be processed on international cloud infrastructure (Azure Singapore) with AES-256 encryption. All PII and encryption keys remain securely within Pakistan. Production deployments for regulated sectors utilize fully Pakistan-based infrastructure.",
          },
        ],
      },
      {
        ...
        groups: [
          {
            ...
            intro:
              "We share information with trusted infrastructure partners under strict Data Processing Agreements. Our current sub-processors include:",
            items: [
              "Azure (Microsoft) - Cloud hosting (Pilot phase, Singapore)",
              "Nexus Cloud VPS - Production infrastructure (Pakistan)",
              "NADRA - Identity verification services",
            ],
          },
          {
      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            items: [
              " Our platform uses a multi-tier pipeline for security and speed:  • Ingestion: Data hits our authenticated Ingest API Router and is split into three dedicated workers (EDR, PECA, and FBR) to ensure performance.  • Hosting: During your 15-day Pilot, data is processed on Digital Ocean. Upon upgrading to Production, we migrate you to 100% Pakistan-based infrastructure (Nexus Cloud VPS).  • Archiving: We use an automated Cron job to move logs to encrypted Azure Cold Storage for 6-year compliance.   ",
            ],
          },
          {
            title: "7.3 Disaster Recovery ",
            items: [
              "• Backups: Daily automated backups with 30-day retention.  • Resilience: Recovery Time Objective (RTO) of 4 hours and Recovery Point Objective (RPO) of 24 hours.  • Data Sovereignty: All production backups and encryption keys are stored securely within Pakistan.",
            ],
          },
        ],
      },
