...
import ConfigurationAssessment from "../Compliance/ConfigurationAssessment";
...
function Dashboard() {
  ...
  const relayEnabled = import.meta.env.VITE_NETWORK_RELAY_ENABLED === "true" || currentUser?.relay_entitlement?.enabled === true;
  const [relayCapability, setRelayCapability] = useState(null);
  const canViewRelay = relayEnabled && (relayCapability?.entitled === true || currentUser?.relay_entitlement?.entitled === true);
      ...
      <main className="siem-main">
        ...
        <div className="content-scrollable">
          <div className="dashboard-container">
            ...
            {canViewSca && activeTab === "configuration" && (
