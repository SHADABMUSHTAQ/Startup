...
CRITICAL_EVENT_MAP = {
    ...
    4732: {
        "mitre_tactic": "T1098 — Account Manipulation (Privilege Escalation)",
        "severity": "HIGH",
        "summary": "User added to security-enabled group — privilege escalation risk",
        "event_type": "SECURITY_GROUP_MEMBERSHIP_CHANGE",
    },
    4733: {
        "mitre_tactic": "T1098 — Account Manipulation (Privilege Escalation)",
        "severity": "HIGH",
        "summary": "User removed from security-enabled group — access modification",
        "event_type": "SECURITY_GROUP_MEMBERSHIP_CHANGE",
    },
}
...
CONSUMER_NAME = os.environ.get("CONSUMER_NAME", "default_hunter")
BLOCK_MS = 5000
BATCH_SIZE = 50
