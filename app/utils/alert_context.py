...
def build_alert_context(alert: Mapping[str, Any], source_event: Mapping[str, Any] | None = None) -> dict:
    ...
    context = {
        ...
        "network_device_id": _first(layers, "network_device_id", "device_id", "source_id"),
        "network_vendor": _first(layers, "network_vendor", "vendor"),
        "actor": actor,
        ...
        "source_port": _first(layers, "source_port", "SourcePort", "src_port"),
        ...
        "action": _first(layers, "action", "Action"),
        "interface": _first(
            layers,
            "interface",
            "interface_in",
